...
export abstract class Props {
  @ValueObjectProp() institute: UserEducationInstitute;
  @ValueObjectProp() title: UserEducationTitle;
  @ValueObjectProp() startDate: Date;
  @ValueObjectProp() endDate: Date;
  @ValueObjectProp() isCurrentStudy: boolean;
  @ValueObjectProp() description: UserEducationDescription;
}
